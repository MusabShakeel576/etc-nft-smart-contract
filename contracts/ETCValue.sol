...
contract ETCValue is ERC721, ERC721Enumerable, AccessControl {
    using Counters for Counters.Counter;

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 100000;
    uint256 public mintPrice = 1717000000000000000000;
    
    constructor() ERC721("ETCValue", "ETCV") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://nft.lingouni.com/metadata/value/value.php?id=";
    }
